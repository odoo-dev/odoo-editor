            ...
            describe('Checklist', () => {
                describe('Insert', () => {
                    it('should turn an empty paragraph into a checklist', async () => {
                        await testEditor(BasicEditor, {
                            ...
                            // JW cAfter: '<ul class="checklist"><li>[]<br></li></ul>',
                    ...
                    it('should turn a paragraph into a checklist', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<p>ab[]cd</p>',
                            stepFunction: toggleCheckList,
                            // JW cAfter: '<ul class="checklist"><li>ab[]cd</li></ul>',
                    ...
                    it('should turn a heading into a checklist', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<h1>ab[]cd</h1>',
                            stepFunction: toggleCheckList,
                            // JW cAfter: '<ul class="checklist"><li><h1>ab[]cd</h1></li></ul>',
                    ...
                    it('should turn a paragraph in a div into a checklist', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<div><p>ab[]cd</p></div>',
                            stepFunction: toggleCheckList,
                            // JW cAfter: '<div><ul class="checklist"><li>ab[]cd</li></ul></div>',
                    ...
                    it('should turn a paragraph with formats into a checklist', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<p><span><b>ab</b></span> <span><i>cd</i></span> ef[]gh</p>',
                            stepFunction: toggleCheckList,
                            // JW cAfter: '<ul class="checklist"><li><span><b>ab</b></span> <span><i>cd</i></span> ef[]gh</li></ul>',
                            contentAfter:
                                '<ul class="checklist"><li><span><b>ab</b></span> <span><i>cd</i></span> ef[]gh</li></ul>',
                        });
                    });
                    it('should turn a paragraph into a checklist betweet 2 checklist', async () => {
                        await testEditor(BasicEditor, {
                            ...
                            stepFunction: toggleCheckList,
                            // JW cAfter: '<ul class="checklist"><li class="checked">abc</li><li>d[]ef</li><li class="checked">ghi</li></ul>',
                            contentAfter:
                                '<ul class="checklist"><li class="checked">abc</li><li>d[]ef</li><li class="checked">ghi</li></ul>',
                        });
                    });
                ...
                describe('Remove', () => {
                    ...
                    it('should turn a checklist into a paragraph', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<ul class="checklist"><li>ab[]cd</li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter: '<p>ab[]cd</p>',
                        });
                    });
                    it('should turn a checklist into a heading', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<ul class="checklist"><li><h1>ab[]cd</h1></li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter: '<h1>ab[]cd</h1>',
                        });
                    });
                    it('should turn a checklist item into a paragraph', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<p>ab</p><ul class="checklist"><li>cd</li><li>ef[]gh</li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter:
                                '<p>ab</p><ul class="checklist"><li>cd</li></ul><p>ef[]gh</p>',
                        });
                    });
                ...
                describe('Insert', () => {
                    it('should turn a paragraph into a checklist', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<p>ab</p><p>cd[ef]gh</p>',
                            stepFunction: toggleCheckList,
                            contentAfter: '<p>ab</p><ul class="checklist"><li>cd[ef]gh</li></ul>',
                        });
                    });
                    it('should turn a heading into a checklist', async () => {
                        await testEditor(BasicEditor, {
                    ...
                    it('should turn a paragraph and a checklist item into two list items', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<p>a[b</p><ul class="checklist"><li class="checked">c]d</li><li>ef</li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter:
                                '<ul class="checklist"><li>a[b</li><li class="checked">c]d</li><li>ef</li></ul>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                    ...
                    it('should turn a checklist item and a paragraph into two list items', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>ab</li><li class="checked">c[d</li></ul><p>e]f</p>',
                            stepFunction: toggleCheckList,
                            contentAfter:
                                '<ul class="checklist"><li>ab</li><li class="checked">c[d</li><li>e]f</li></ul>',
                        });
                    });
                    it('should turn a checklist, a paragraph and another list into one list with three list items', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>a[b</li></ul><p>cd</p><ul class="checklist"><li class="checked">e]f</li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter:
                                '<ul class="checklist"><li>a[b</li><li>cd</li><li class="checked">e]f</li></ul>',
                        });
                    });
                    ...
                    it('should turn a checklist, a paragraph and a checklist item into one list with all three as list items', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">a[b</li></ul><p>cd</p><ul class="checklist"><li class="checked">e]f</li><li>gh</li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter:
                                '<ul class="checklist"><li class="checked">a[b</li><li>cd</li><li class="checked">e]f</li><li>gh</li></ul>',
                        });
                    });
                });
                describe('Remove', () => {
                    it('should turn a checklist into a paragraph', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore: '<p>ab</p><ul class="checklist"><li>cd[ef]gh</li></ul>',
                            stepFunction: toggleCheckList,
                            contentAfter: '<p>ab</p><p>cd[ef]gh</p>',
                        });
                    });
            ...
            describe('Mixed', () => {
                ...
                it('should turn an unordered list into a checklist', async () => {
                    await testEditor(BasicEditor, {
                        contentBefore: '<ul><li>a[b]c</li></ul>',
                        stepFunction: toggleCheckList,
                        contentAfter: '<ul class="checklist"><li>a[b]c</li></ul>',
                    });
                });
                it('should turn an unordered list into a checklist just after a checklist', async () => {
                    await testEditor(BasicEditor, {
                        ...
                        stepFunction: toggleCheckList,
                        contentAfter:
                            '<ul class="checklist"><li class="checked">abc</li><li>d[e]f</li></ul>',
                    });
                });
            ...
            describe('Selection collapsed', () => {
                describe('Basic', () => {
                    ...
                    it('should delete the first character in a checklist item', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">abc</li><li>[]defg</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li class="checked">abc</li><li>[]efg</li></ul>',
                        });
                    });
                    it('should delete a character within a checklist item', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">abc</li><li>de[]fg</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li class="checked">abc</li><li>de[]g</li></ul>',
                        });
                    });
                    it('should delete the last character in a checklist item', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">abc</li><li>def[]g</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li class="checked">abc</li><li>def[]</li></ul>',
                        });
                    });
                    ...
                    it('should merge a checklist item with its next list item', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">abc</li><li>def[]</li><li class="checked">ghi</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li class="checked">abc</li><li>def[]ghi</li></ul>',
                        });
                        // Where the list item to merge into is empty, with an
                        // empty list item before.
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li><br></li><li>[]<br></li><li>abc</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter: '<ul class="checklist"><li><br></li><li>[]abc</li></ul>',
                        });
                    });
                    it('should rejoin sibling lists', async () => {
                        await testEditor(BasicEditor, {
                ...
                describe('Indented', () => {
                    ...
                    it('should merge the only item in an indented list into a non-indented list item and remove the now empty indented list', async () => {
                        await testEditor(BasicEditor, {
                            ...
                            contentAfter: '<ul class="checklist"><li>abc[]def</li></ul>',
                        });
                    });
                });
                describe('Complex merges', () => {
                    ...
                    it('should treat two blocks in a checklist item (checked/unchecked) as two list items and merge them', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked"><h1>abc</h1></li><li><h2>def[]</h2><h3>ghi</h3></li><li class="checked"><h4>klm</h4></li></ul>',
                            stepFunction: deleteForward,
                            // Paragraphs in list items are treated as nonsense.
                            // unchecked folowed by checked
                            contentAfter:
                                '<ul class="checklist"><li class="checked"><h1>abc</h1></li><li><h2>def[]ghi</h2></li><li class="checked"><h4>klm</h4></li></ul>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked"><h1>abc</h1></li><li class="checked"><h2>def[]</h2><h3>ghi</h3></li><li><h4>klm</h4></li></ul>',
                            stepFunction: deleteForward,
                            // Paragraphs in list items are treated as nonsense.
                            // checked folowed by unchecked
                            contentAfter:
                                '<ul class="checklist"><li class="checked"><h1>abc</h1></li><li class="checked"><h2>def[]ghi</h2></li><li><h4>klm</h4></li></ul>',
                        });
                    });
                    it('should merge a bold list item into a non-formatted list item', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>abc</li><li><b>de</b>fg[]</li><li><b>hij</b>klm</li><li>nop</li></ul>',
                            stepFunction: deleteForward,
                            // all checked
                            contentAfter:
                                '<ul class="checklist"><li>abc</li><li><b>de</b>fg[]<b>hij</b>klm</li><li>nop</li></ul>',
                        });
                    });
                    it('should merge a bold list item (checked/unchecked) into a non-formatted list item', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">abc</li><li class="checked"><b>de</b>fg[]</li><li><b>hij</b>klm</li><li class="checked">nop</li></ul>',
                            stepFunction: deleteForward,
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>abc</li><li><b>de</b>fg[]</li><li class="checked"><b>hij</b>klm</li><li>nop</li></ul>',
                            stepFunction: deleteForward,
                    ...
                    it('should merge a paragraph starting with bold text into a checklist item with ending without formatting', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li><i>abc</i>def[]</li></ul><p><b>ghi</b>jkl</p>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li><i>abc</i>def[]<b>ghi</b>jkl</li></ul>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                    ...
                    it('should merge a paragraph starting with bold text into a checklist item with ending with italic text', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li><b>abc</b><i>def[]</i></li></ul><p><b>ghi</b>jkl</p>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li><b>abc</b><i>def[]</i><b>ghi</b>jkl</li></ul>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                ...
                describe('Complex merges with some containers parsed in list item', () => {
                    ...
                    it('should merge a bold list item (checked/unchecked) into a non-formatted list item', async () => {
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked"><p>abc</p></li><li><p><b>de</b>fg[]</p><p><b>hij</b>klm</p></li><li class="checked"><p>nop</p></li></ul>',
                            stepFunction: deleteForward,
            ...
            describe('Selection not collapsed', () => {
                ...
                describe('Checklist', () => {
                    it('should delete text within a checklist item', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore: '<ul class="checklist"><li>ab[cd]ef</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter: '<ul class="checklist"><li>ab[]ef</li></ul>',
                        });
                        // Backward selection
                        await testEditor(BasicEditor, {
                            contentBefore:
                    ...
                    it('should delete all the text in a checklist item', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore: '<ul class="checklist"><li>[abc]</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter: '<ul class="checklist"><li>[]<br></li></ul>',
                        });
                        // Backward selection
                    ...
                    it('should delete across two list items', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">ab[cd</li><li>ef]gh</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<ul class="checklist"><li class="checked">ab[]gh</li></ul>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>ab[cd</li><li class="checked">ef]gh</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter: '<ul class="checklist"><li>ab[]gh</li></ul>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>ab[cd</li><li>ef]gh</li></ul>',
                            stepFunction: deleteForward,
                            contentAfter: '<ul class="checklist"><li>ab[]gh</li></ul>',
                        });
                        // Backward selection
                    ...
                    it('should delete across an unindented list item and an indented list item', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li>ab[cd</li><li class="nested"><ul class="checklist"><li>ef]gh</li></ul></li></ul>',
                            stepFunction: deleteForward,
                    ...
                    it('should merge the contents of a checklist item within a divider into a heading, and leave the rest of its list as it is', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<h1>a[b</h1><p>de</p><div><ul class="checklist"><li>fg</li><li>h]i</li><li class="checked">jk</li></ul></div>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<h1>a[]i</h1><div><ul class="checklist"><li class="checked">jk</li></ul></div>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<h1>a[b</h1><p>de</p><div><ul class="checklist"><li class="checked">fg</li><li>h]i</li><li>jk</li></ul></div>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<h1>a[]i</h1><div><ul class="checklist"><li>jk</li></ul></div>',
                        });
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<h1>a[b</h1><p>de</p><div><ul class="checklist"><li>fg</li><li>h]i</li><li>jk</li></ul></div>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<h1>a[]i</h1><div><ul class="checklist"><li>jk</li></ul></div>',
                        });
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<h1>a]b</h1><p>de</p><div><ul class="checklist"><li>fg</li><li class="checked">h[i</li><li>jk</li></ul></div>',
                            stepFunction: deleteForward,
                            contentAfter:
                                '<h1>a[]i</h1><div><ul class="checklist"><li>jk</li></ul></div>',
                        });
                ...
                describe('Mixed', () => {
                    ...
                    describe('Checklist to unordered', () => {
                        it('should delete across an checklist list and an unordered list', async () => {
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>ab[cd</li></ul><ul><li class="checked">ef]gh</li></ul>',
                                stepFunction: deleteForward,
                                contentAfter: '<ul class="checklist"><li>ab[]gh</li></ul>',
                            });
                            await testEditor(BasicEditor, {
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>ab[cd</li></ul><ul><li>ef]gh</li></ul>',
                                stepFunction: deleteForward,
                                contentAfter: '<ul class="checklist"><li>ab[]gh</li></ul>',
                            });
                            // Backward selection
                        ...
                        it('should delete across an checklist list item and an unordered list item within an checklist list', async () => {
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>ab[cd</li><li class="nested"><ul><li>ef]gh</li></ul></li></ul>',
                                stepFunction: deleteForward,
                                contentAfter: '<ul class="checklist"><li>ab[]gh</li></ul>',
                            });
                            // Backward selection
                ...
                describe('Checklist', () => {
                    describe('Basic', () => {
                        ...
                        it('should merge a list item with its previous list item', async () => {
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>abc</li><li class="checked">[]def</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter: '<ul class="checklist"><li>abc[]def</li></ul>',
                            });
                            // With another list item after.
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li class="checked">abc</li><li>[]def</li><li>ghi</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul class="checklist"><li class="checked">abc[]def</li><li>ghi</li></ul>',
                            });
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li class="checked">abc</li><li>[]def</li><li class="checked">ghi</li></ul>',
                    ...
                    describe('Indented', () => {
                        ...
                        it('should outdent an empty list within a list', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>abc</li><li class="nested"><ul class="checklist"><li>[]<br></li></ul></li><li class="checked">def</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul class="checklist"><li>abc</li><li>[]<br></li><li class="checked">def</li></ul>',
                            });
                        });
                        it('should outdent an empty list', async () => {
                            await testEditor(BasicEditor, {
                        ...
                        it("should outdent a list to the point that it's a paragraph", async () => {
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<p><br></p><ul class="checklist"><li>[]<br></li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter: '<p><br></p><p>[]<br></p>',
                            });
                        });
                    ...
                    describe('Complex merges', () => {
                        it('should merge a list item into a paragraph', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                contentAfter:
                                    '<p>abcd[]gh</p><ul class="checklist"><li class="checked">ij</li></ul>',
                            });
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<p>abcd</p><ul class="checklist"><li>ef[]gh</li><li class="checked">ij</li></ul>',
                                stepFunction: async editor => {
                                    await deleteBackward(editor);
                                    await deleteBackward(editor);
                                    await deleteBackward(editor);
                            ...
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<p>abcd</p><ul class="checklist"><li class="checked">ef[]gh</li><li>ij</li></ul>',
                                stepFunction: async editor => {
                                    await deleteBackward(editor);
                                    await deleteBackward(editor);
                                    await deleteBackward(editor);
                                ...
                                contentAfter:
                                    '<p>abc[]gh</p><ul class="checklist"><li>ij</li></ul>',
                            });
                        });
                        it('should merge a paragraph into a list item', async () => {
                            await testEditor(BasicEditor, {
                ...
                describe('Mixed', () => {
                    describe('Ordered to unordered', () => {
                        ...
                        it('should merge an ordered list item that is in an unordered list item into a non-indented list item', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul><li>abc</li><li>[]def</li><li class="nested"><ol><li>ghi</li></ol></li></ul>',
                            });
                        });
                    ...
                    describe('Checklist to unordered', () => {
                        ...
                        it('should outdent an empty checklist list item within an unordered list', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul><li>abc</li><li class="nested"><ul class="checklist"><li>[]<br></li><li><br></li></ul></li><li>def</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul><li>abc</li><li>[]<br></li><li class="nested"><ul class="checklist"><li><br></li></ul></li><li>def</li></ul>',
                            });
                        });
                        it('should outdent an empty checklist list within an unordered list', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul><li>abc</li><li class="nested"><ul class="checklist"><li>[]<br></li></ul></li><li>def</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter: '<ul><li>abc</li><li>[]<br></li><li>def</li></ul>',
                            });
                        });
                        it('should outdent an empty checklist list within an unordered list', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul><li class="nested"><ul class="checklist"><li><br>[]</li></ul></li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter: '<ul><li>[]<br></li></ul>',
                            });
                        });
                    ...
                    describe('Unordered to checklist', () => {
                        ...
                        it('should outdent an unordered list item that is within a checklist list', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                stepFunction: deleteBackward,
                                contentAfter: '<ul class="checklist"><li>[]abc</li></ul>',
                            });
                            // With a paragraph before the list:
                            await testEditor(BasicEditor, {
                                contentBefore:
                                ...
                                stepFunction: deleteBackward,
                                contentAfter: '<p>abc</p><ul class="checklist"><li>[]def</li></ul>',
                            });
                        });
                        it('should outdent an empty unordered list item within an checklist list (checked)', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul class="checklist"><li class="checked">abc</li><li>[]<br></li><li class="nested"><ul><li><br></li></ul></li><li class="checked">def</li></ul>',
                            });
                        });
                        it('should outdent an empty unordered list item within an checklist list (unchecked)', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>abc</li><li class="nested"><ul><li>[]<br></li><li><br></li></ul></li><li>def</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul class="checklist"><li>abc</li><li>[]<br></li><li class="nested"><ul><li><br></li></ul></li><li>def</li></ul>',
                            });
                        });
                        it('should outdent an empty unordered list within an checklist list (checked)', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul class="checklist"><li class="checked">abc</li><li>[]<br></li><li class="checked">def</li></ul>',
                            });
                        });
                        it('should outdent an empty unordered list within an checklist list (unchecked)', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>abc</li><li class="nested"><ul><li>[]<br></li></ul></li><li>def</li></ul>',
                                stepFunction: deleteBackward,
                                contentAfter:
                                    '<ul class="checklist"><li>abc</li><li>[]<br></li><li>def</li></ul>',
                            });
                        });
            ...
            describe('Selection not collapsed', () => {
                ...
                describe('Checklist', () => {
                    ...
                    it('should delete across an unindented list item and an indented list item', async () => {
                        ...
                        await testEditor(BasicEditor, {
                            contentBefore:
                                '<ul class="checklist"><li class="checked">ab[cd</li><li class="nested"><ul class="checklist"><li>ef]gh</li></ul></li></ul>',
                            stepFunction: deleteBackward,
                    ...
                    describe('Basic', () => {
                        ...
                        it('should split a checklist item in two (unchecked)', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore: '<ul class="checklist"><li>ab[]cd</li></ul>',
                                stepFunction: insertParagraphBreak,
                                contentAfter: '<ul class="checklist"><li>ab</li><li>[]cd</li></ul>',
                            });
                        });
                        it('should split a checklist item in two (checked)', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                stepFunction: insertParagraphBreak,
                                contentAfter:
                                    '<ul class="checklist"><li class="checked">ab</li><li>[]cd</li></ul>',
                            });
                        });
                    ...
                    describe('Removing items', () => {
                        ...
                        it('should add an empty list item at the end of an indented list, then outdent it (checked)', async () => {
                            await testEditor(BasicEditor, {
                                ...
                                contentAfter:
                                    '<ul class="checklist"><li class="checked">abc</li><li class="nested"><ul class="checklist"><li class="checked">def</li></ul></li><li>[]<br></li><li class="checked">ghi</li></ul>',
                            });
                        });
                        it('should add an empty list item at the end of an indented list, then outdent it (unchecked)', async () => {
                            await testEditor(BasicEditor, {
                                contentBefore:
                                    '<ul class="checklist"><li>abc</li><li class="nested"><ul class="checklist"><li>def[]</li></ul></li><li class="checked">ghi</li></ul>',
                                stepFunction: async editor => {
                                    await insertParagraphBreak(editor);
                                    await insertParagraphBreak(editor);
                                },
                                contentAfter:
                                    '<ul class="checklist"><li>abc</li><li class="nested"><ul class="checklist"><li>def</li></ul></li><li>[]<br></li><li class="checked">ghi</li></ul>',
                            });
                        });
