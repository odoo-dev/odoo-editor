import { patienceDiff } from './utils/patienceDiff.js';
...
export class CommandBar {
            ...
            for (const command of commands) {
                ...
                commandElWrapper.innerHTML = `
                    <div class="oe-commandbar-commandLeftCol">
                        <img class="oe-commandbar-commandImg" />
                    </div>
                ...
                commandImgEl.src = command.imageSrc;
    ...
    _filter(term) {
        ...
        const regex = new RegExp(term.replaceAll(' ', 'b').split('').join('.*'));
        if (term.length) {
